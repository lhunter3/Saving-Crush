...
class Button():
	...
	def __init__(self, x, y, text,font,w,h):
		self.x = x
		self.y = y
		self.text = text
		self.font = font
	...
	def draw(self, surface):
		...
		#button_rect = Rect(self.x, self.y - 25, self.width, self.height)
		...
		#surface.blit(text_img, (self.x + int(self.width / 2) - int(text_len / 2), self.y - 25 + int(self.height/2 - int(text_hi/2))))

		return action


	def draw2(self, surface, sound):
